...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BotGarden.Core.Models.BotGardenMode", b =>
                {
            ...
            modelBuilder.Entity("BotGarden.Core.Models.Collections", b =>
                {
            ...
            modelBuilder.Entity("BotGarden.Core.Models.Genus", b =>
                {
            ...
            modelBuilder.Entity("BotGarden.Core.Models.PlantFamilies", b =>
                {
            ...
            modelBuilder.Entity("BotGarden.Core.Models.Plants", b =>
                {
            ...
            modelBuilder.Entity("BotGarden.Core.Models.Sectors", b =>
                {
                    b.Property<int>("SectorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BotGarden.Core.Models.Plants", b =>
                {
                    b.HasOne("BotGarden.Core.Models.BotGardenMode", null)
                        .WithMany("Plants")
                        .HasForeignKey("BotGardenModeLocationId");

                    b.HasOne("BotGarden.Core.Models.Collections", null)
                        .WithMany("Plants")
                        .HasForeignKey("CollectionsCollectionId");

                    b.HasOne("BotGarden.Core.Models.PlantFamilies", "Family")
                        .WithMany("Plants")
                        .HasForeignKey("FamilyId");

                    b.HasOne("BotGarden.Core.Models.Genus", "Genus")
                        .WithMany("Plants")
                        .HasForeignKey("GenusId");

                    b.HasOne("BotGarden.Core.Models.Sectors", "Sector")
                        .WithMany("Plants")
